<template>
  <div>
    ...
    <div v-else-if="this.mainStore.currentUser.friendsId.includes(this.id)"
      ...
      <div class="space-y-4 flex flex-col items-center">
        ...
        <div>Si me conoces, prueba a adivinar cómo respondería yo a estas preguntas.</div>
    ...
    <div v-else
      ...
      <div class="space-y-4 flex flex-col items-center">
        ...
        <div class="text-2xl">Hola, soy <span v-text="this.currentUser?.name"></span>!</div>
        <div>¿Quieres agregarme como amigo/a?</div>
      </div>
    </div>
