  ...
  <form>
    ...
    <div class="w-full bg-zinc-800 p-8 my-4 text-center space-y-4 sm:w-3/5 lg:w-1/2 mx-auto sm:rounded-lg overflow-hidden dark:border dark:border-zinc-700">
      ...
      <div class="space-y-8">
        ...
        <div>
            <label for="email" class="text-start block mb-2 text-sm font-medium text-zinc-900 dark:text-white">Email</label>
            <input required type="email" id="email" placeholder="Tu email" v-model="email" class="bg-zinc-50 border border-zinc-300 text-zinc-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-zinc-800 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
        </div>
        <div>
            <label for="password" class="text-start block mb-2 text-sm font-medium text-zinc-900 dark:text-white">Contraseña</label>
            <input required type="password" id="password" placeholder="Tu contraseña" v-model="password" class="bg-zinc-50 border border-zinc-300 text-zinc-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-zinc-800 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
        </div>
